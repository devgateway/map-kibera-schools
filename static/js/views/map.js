  ...
  pinSchool: function(school, opts) {
    ...
    if (opts.feature) {
      pinOptions.popupTemplate = _.template(
        ...
        '<% } %>' +
        '<div class="share">' +
          '<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://openschoolskenya.org/schools/<%= slug %>">Tweet</a>' +
          '<div class="fb-like" data-href="http://openschoolskenya.org/schools/<%= slug %>" data-width="80" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>' +
        '</div>');
    }
